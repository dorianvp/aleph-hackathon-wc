...
export default function Component() {
  ...
  const [campaign, setCampaign] = useState({
    ...
    isPublic: true,
    images: [],
    anonymous: false, // Changed from creatorVisibility
    goal: "",
    currency: "USDC",
    optimismAddress: "",
  });
  ...
  const handleSelectChange = (name: string, value: boolean | string) => {
    setCampaign((prev) => ({ ...prev, [name]: value }));
  };
  ...
  return (
    <div className="container mx-auto p-4 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="anonymous">Creator Visibility</Label>
          <Select
            value={campaign.anonymous ? "anonymous" : "public"}
            onValueChange={(value) =>
              handleSelectChange("anonymous", value === "anonymous")
            }
          >
            <SelectTrigger id="anonymous">
        ...
        <div className="space-y-2">
          <Label htmlFor="optimismAddress">Optimism Address</Label>
          <Input
            id="optimismAddress"
            name="optimismAddress"
            value={campaign.optimismAddress}
            onChange={handleInputChange}
            placeholder="Enter your Optimism address"
            required
          />
        </div>
