...
export default function Component() {
  const featuredCampaign = {
    ...
    description: "Urgent support needed for victims of the recent earthquake. Provide food, shelter, and medical aid.",
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="container px-4 md:px-6">
            ...
            <Card className="w-full max-w-3xl mx-auto">
              ...
              <CardContent className="space-y-2">
                <CardTitle className="text-xl md:text-2xl">{featuredCampaign.title}</CardTitle>
                <p className="text-muted-foreground text-sm md:text-base">{featuredCampaign.description}</p>
                <Progress className="w-full" value={(featuredCampaign.raised / featuredCampaign.goal) * 100} />
                <p className="font-medium text-sm md:text-base">
                  ${featuredCampaign.raised.toLocaleString()} raised of ${featuredCampaign.goal.toLocaleString()} goal
                </p>
              </CardContent>
              <CardFooter>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {campaigns.map((campaign) => (
                <Card key={campaign.id} className="flex flex-col">
                  <Link href={`/campaigns/jason-recovery`}>
                    ...
                    <CardContent className="flex-grow p-4 space-y-2">
                      <CardTitle className="text-lg md:text-xl line-clamp-1">{campaign.title}</CardTitle>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-primary-foreground/80 text-sm md:text-base lg:text-lg">
                  Subscribe to our newsletter for the latest campaign updates and success stories.
                </p>
              </div>
              <div className="w-full max-w-sm space-y-2">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">© 2023 Patronix. All rights reserved.</p>
